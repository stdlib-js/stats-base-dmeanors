...
<div class="equation" align="center" data-raw-text="\mu = \frac{1}{n} \sum_{i=0}^{n-1} x_i" data-equation="eq:arithmetic_mean">
    <img src="https://cdn.rawgit.com/stdlib-js/stdlib/b72d42326940ced4705f5ac33db521be4fb7a2bc/lib/node_modules/@stdlib/stats/base/dmeanors/docs/img/equation_arithmetic_mean.svg" alt="Equation for the arithmetic mean.">
    <br>
</div>
...
```bash
npm install @stdlib/stats-base-dmeanors
```
...
[test-image]: https://github.com/stdlib-js/stats-base-dmeanors/actions/workflows/test.yml/badge.svg
[test-url]: https://github.com/stdlib-js/stats-base-dmeanors/actions/workflows/test.yml
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-base-dmeanors
